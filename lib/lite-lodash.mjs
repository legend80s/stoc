 ...
 *
 * @example
 * const strs = ['/api/model/v1/evaluate/job/', '/api/model/v1/evaluate/result/list', `/api/model/v1/evaluate/job/list`, '/api/model/v1/evaluate/infer-data/{id}', '/api/model/v1/evaluate/infer-data/list']
 *
 * findMaxPrefixSubstring(strs) // '/api/model/v1/evaluate/'
 */
