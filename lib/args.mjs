 ...
 *
 * @param {string[]} args
 * @returns {{ parsed: { help: boolean; input?: string | undefined; api: string; method: string; debug: boolean; verbose: boolean; 'types-only': boolean; 'function-only': boolean; grouped: boolean; 'use-interface': boolean; request: boolean; }; options: any }}
 * @example
